...
class SearchMovieModel extends SearchEntity {
  ...
  factory SearchMovieModel.fromJson(String str) =>
      SearchMovieModel.fromMap(json.decode(str));

  factory SearchMovieModel.fromMap(Map<String, dynamic> json) =>
      SearchMovieModel(
        page: json["page"],
  ...
  factory SearchMovieModel.fromEntity(SearchEntity entity) {
